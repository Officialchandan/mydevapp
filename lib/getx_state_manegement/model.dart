...
//
//     final dataFormUser = dataFormUserFromJson(jsonString);

import 'dart:convert';

import 'package:get/get_rx/src/rx_types/rx_types.dart';

List<DataFormUser> dataFormUserFromJson(String str) => List<DataFormUser>.from(
    json.decode(str).map((x) => DataFormUser.fromJson(x)));

String dataFormUserToJson(List<DataFormUser> data) =>
